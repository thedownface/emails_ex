...
SECRET_KEY = 'django-insecure-ml#o0%pwa7eai4n%ckod*1+=9^ks%*n=(%!6*bjnoy6%p(mo+8'
...
DRIVERS=os.path.join(BASE_DIR,'driver')
DRIVERS_URL='/driver'
...
CELERY_BROKER_URL="transport://userid:password@hostname:port/virtual_host"
